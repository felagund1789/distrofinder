...
interface FiltersProps {
  onDistrosChange: (distros: readonly Distro[]) => void;
}

export default function Filters({ onDistrosChange }: FiltersProps) {
  ...
  useEffect(() => {
    ...
    onDistrosChange(distros);
  }, [filters, debouncedSearch, search, onDistrosChange]);
