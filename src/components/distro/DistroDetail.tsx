...
export default function DistroDetail({ distro }: { distro?: Distro }) {
  if (!distro) {
    ...
    <article className="detail">
      ...
      <section className="distro-tech">
        ...
        <div className="distro-tech__group">
          ...
          <DefinitionRow label="Default Browser">
            {distro.defaultBrowser || "—"}
          </DefinitionRow>
          <DefinitionRow label="Installation">
            {distro.installation || "—"}
          </DefinitionRow>
          <DefinitionRow label="Package Management">
            {distro.packageManagement || "—"}
          </DefinitionRow>
          <DefinitionRow label="Office Suite">
            {distro.officeSuite || "—"}
          </DefinitionRow>
          <DefinitionRow label="Processor Architecture">
            {distro.processorArchitecture || "—"}
          </DefinitionRow>
          <DefinitionRow label="Init System">
            {distro.initSystem || "—"}
          </DefinitionRow>
          <DefinitionRow label="File Systems">
            {distro.fileSystems || "—"}
          </DefinitionRow>
